...
public struct HeatmapGraph: View {
    ...
    public init(matriz:[[Double]], showNumero: Bool, legendaColuna: [String], legendaLinha: [String]){
        self.showNumero = showNumero
        self.matriz = matriz
        self.legendaColuna = legendaColuna
        self.legendaLinha = legendaLinha
    }
